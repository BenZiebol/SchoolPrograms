...
SimulationModel::SimulationModel(IController& controller)
    ...
    compositefactory.addFactory(new RobotFactory());
    compositefactory.addFactory(new DroneFactory());
    compositefactory.addFactory(new PackageFactory());
    compositefactory.addFactory(new HelicopterFactory());
    compositefactory.addFactory(new HumanFactory());
}
...
IEntity* SimulationModel::createEntity(const JsonObject& entity) {
  ...
  IEntity* myNewEntity = compositefactory.createEntity(entity);
